...
export default function Sidebar({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="text-slate-950 dark:bg-gray-800 dark:text-white">
        <SheetHeader>
                  ...
                  <li key={stopName + stopId}>
                    <div className="flex flex-row">
                      ...
                      <button
                        ...
                        className="flex items-center border-b border-gray-200 p-1.5 text-gray-400 ring-inset hover:bg-gray-100 hover:text-red-900 focus-visible:ring-2 focus-visible:ring-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-500 dark:hover:bg-gray-700 dark:hover:text-red-600"
                      >
